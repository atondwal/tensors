...
$$ L^a = I^a_b \omega^b $$
We transform the angular momentum to our greeked coordinate system. 
$$ L^\alpha = T^\alpha_a L^a = T^\alpha_a I^a_b T^b_\beta T^\beta_b\omega^b = \left[T^\alpha_a I^a_b T^-1^\beta_b\right]\omega^\beta$$
So we have the fact that $$I^\alpha_\beta = \left[T^\alpha_a I^a_b T_\beta^b\right]$$
Returning to matrix notation, I is transformed by:
$$I' = T I T^{-1}$$
\end{document}
