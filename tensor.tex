...
When we take the direct product of two tensors, we add up the covariant indicies and the contravariant indices, and get a tensor of a higher rank. We can take the 
\end{document}
